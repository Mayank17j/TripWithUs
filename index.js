...
function hotelsPricingLowToHigh(hotelsCopyObj1, hotelsCopyObj2) {
  return hotelsCopyObj1.price - hotelsCopyObj2.price;
}
function hotelsPricingHighToLow(hotelsCopyObj1, hotelsCopyObj2) {
  return hotelsCopyObj2.price - hotelsCopyObj1.price;
}
...
function hotelsRatingLowToHigh(hotelsCopyObj1, hotelsCopyObj2) {
  return hotelsCopyObj1.rating - hotelsCopyObj2.rating;
}
function hotelsRatingHighToLow(hotelsCopyObj1, hotelsCopyObj2) {
  return hotelsCopyObj2.rating - hotelsCopyObj1.rating;
}
...
function hotelsReviewsLeastToMost(hotelsCopyObj1, hotelsCopyObj2) {
  return hotelsCopyObj1.reviews - hotelsCopyObj2.reviews;
}
function hotelsReviewsMostToLeast(hotelsCopyObj1, hotelsCopyObj2) {
  return hotelsCopyObj2.reviews - hotelsCopyObj1.reviews;
}
...
function filterByAmenity(hotelsObj, amenity) {
  if (hotelsObj.amenity.toLowerCase() === amenity) return hotelsObj;
}
